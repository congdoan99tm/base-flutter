...
abstract class AppLocalizations {
  ...
  ///
  /// In vi, this message translates to:
  /// **'Số điện thoại phải có từ 9 đến 12 chữ số'**
  ...
  /// No description provided for @otpEmptyInvalid.
  ///
  /// In vi, this message translates to:
  /// **'Mã OTP không được để trống'**
  String get otpEmptyInvalid;
  ...
  /// No description provided for @otpLengthInvalid.
  ///
  /// In vi, this message translates to:
  /// **'Mã OTP có độ dài 4 ký tự'**
  String get otpLengthInvalid;
}
